...
func replyWhoIsHere(firstName: String, homeCountry: String) -> String {
    return ("It's me, \(firstName), from \(homeCountry)")
}

replyWhoIsHere("Allison", "United States")
...
func tellNameandAge(name: String, dob: Int) -> Int {
    var age = calculateAge(dob)
    println ("\(name), my age is \(age)")
    return age
}

println (tellNameandAge("Allison", 1989))
